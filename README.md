...
"Nostalgic messenger es una plataforma de mensajeria web, esta disponible para todos los SO´s, es posible conectarse a Nostalgic en dispositivos como:
 Android, iPhone, Windows Phone, PC... etc debido a que usamos el navegador para la conexion.
...
"Nostalgic messenger is a platform of web messageing, its availible for all Operative Systems, its posible to conect to **Nostalgic** with devices like:
Android, iPhone, Windows Phone... etc due that we use the web navigator for the conection.
Since **Nostalgic** uses the same data plan that you use for your e-mail or web browsing, there is no extra cost for the messages"

## **Getting Started with Nostalgic:**
...
9. Once that you have logged in, the navigator will show you on the left side a list  with all registred users within **Nostalgic**.    

### **Requirements**

To be able to use **Nostalgic** you just need a browser compatible with: HTML5.  
...
+ [Miguel Guzman.](https://www.linkedin.com/in/miguel-osvaldo-guzman-palomar-069802153/)  
+ [Alejandro Guerrero.](https://www.linkedin.com/in/claudio-alejandro-guerrero-nocedal-a283b9153/)  
+ [Justino Duran.](https://www.linkedin.com/in/justino-duran-perez-826635153/)  

## **License**

This project is based on a GPLv3+: http://www.gnu.org/licenses/gpl-3.0.html license.  



# **Therms and Conditions**

The user shall not use this app for **Marketing** purpuses (SPAM).  
We have the right to block any user that does not folloe this rules.
