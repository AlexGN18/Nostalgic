...
"Nostalgic Messenger es una plataforma de mensageria Web, esta disponible para todos los SO´s, es posible conectarse a Nostalgic en dispositivos como:
...
Para poder utilizar Nostalgic solo ecesitas un navegador Web compatible con : HTML5.
